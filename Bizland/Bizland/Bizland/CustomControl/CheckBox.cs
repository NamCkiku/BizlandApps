...
namespace Bizland.CustomControl
{
    ...
    {
        BoxView boxBackground = new BoxView { HeightRequest = 20, WidthRequest = 20, BackgroundColor = Color.LightGray, VerticalOptions = LayoutOptions.CenterAndExpand };
        ...
        Label lblSelected = new Label { Text = "✓", FontSize = 16, FontAttributes = FontAttributes.Bold, IsVisible = false, TextColor = Color.Accent, HorizontalOptions = LayoutOptions.Center, VerticalOptions = LayoutOptions.CenterAndExpand };
        Label lblOption = new Label { VerticalOptions = LayoutOptions.CenterAndExpand, FontSize = 12 };
