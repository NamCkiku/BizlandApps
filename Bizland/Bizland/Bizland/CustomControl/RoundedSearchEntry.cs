...
namespace Bizland.CustomControl
{
    public class RoundedSearchEntry : Entry
    {
        ...
        public static readonly BindableProperty ColorProperty = BindableProperty.Create(nameof(BorderColor), typeof(Color), typeof(RoundedSearchEntry), Color.FromHex("#f6f6f6"));
        public Color Color
        {
        ...
        public static readonly BindableProperty BorderRadiusProperty = BindableProperty.Create(nameof(BorderRadius), typeof(int), typeof(RoundedSearchEntry), 5);
